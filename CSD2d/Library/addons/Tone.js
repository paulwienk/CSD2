(function(root, factory){
	...
	Module(function (Tone) {
	    ...
	    Tone.TransportRepeatEvent = function (Transport, options) {
	        ...
	        /**
			 * IDs associated with all the callbacks on the timeline
			 * @type {Array}
			 * @private
			 */
	        this._ids = [];
	        /**
			 * The last computed timeline event
			 * @type {Ticks}
			 * @private
			 */
	        this._endTicks = this.time;
	        /**
			 * a reference to the bound start method
			 * @type {Function}
			 * @private
			 */
	        this._boundCreateEvents = this._createEvents.bind(this);
	        this.Transport.on('start', this._boundCreateEvents);
	        this._createEvents();
	    };
	    ...
	    Tone.TransportRepeatEvent.prototype._createEvents = function () {
	        while (this._endTicks < this.Transport.ticks + this._interval * 2 && this._endTicks < this.time + this.duration) {
	            this._ids.push(this.Transport.schedule(this.invoke.bind(this), Tone.TransportTime(this._endTicks, 'i')));
	            this._endTicks += this._interval;
	        }
	    };
	    /**
		 * Clean up
	    ...
	    Tone.TransportRepeatEvent.prototype.dispose = function () {
	        ...
	        this.Transport.off('start loopStart', this._boundCreateEvents);
	...
	Module(function (Tone) {
	    ...
	    Tone.Transport = function () {
	        ...
	        Tone.getContext(function () {
	            ...
	            /**
				 * 	The repeated events with a finite duration.
				 *  @type {Tone.Timeline}
				 *  @private
				 */
	            this._finiteRepeatEvents = new Tone.Timeline();
	            /**
				 *  Repeated events
				 *  @type {Array}
				 *  @private
